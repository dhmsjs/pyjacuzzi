...
# Change this to your spa's ip address
DEFAULT_SPA_IP_ADDR = "192.168.6.156"
...
if __name__ == "__main__":
    ...
    spahost = DEFAULT_SPA_IP_ADDR
    spa = jacuzzi.JacuzziSpaWifi(spahost)
